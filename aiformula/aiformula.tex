...
\caption[AI-Formula mobility.]{AI-Formula mobility. (source: \cite{lang_sam_tracker})}
\label{fig:mobility}
\end{figure}
...
\caption[Course and obstacle used in the experiment.]{Course and obstacle used in the experiment. (source: \cite{lang_sam_tracker})}
\label{fig:cource}
\end{figure}
...
\caption[An example of calculating the vanishing point.]{An example of calculating the vanishing point. (source: \cite{lang_sam_tracker})}
\label{fig:target}
\end{figure}
...
\caption[Obstacle detection using the BBox area as a threshold.]{Obstacle detection using the BBox area as a threshold. (source: \cite{lang_sam_tracker})}
\label{fig:bbox}
\end{figure}
...
\caption[The trajectory of mobility.]{The trajectory of mobility. (source: \cite{lang_sam_tracker})}
\label{fig:follow}
\end{figure}
...
\caption[Result of obstacle detection and stop.]{Result of obstacle detection and stop. (source: \cite{lang_sam_tracker})}
\label{fig:stop}
\end{figure}
\newpage
