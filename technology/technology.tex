...
推論時には，ユーザーが任意のテキストプロンプトを入力でき，単一物体の記述から属性を含む記述，関係性を含む記述まで対応可能である．信頼度スコアが閾値を超える検出のみが最終結果として採用される．この柔軟性により，事前に定義されていない任意の物体カテゴリに対応できる(\Fig{fig:zeroshot_detection})．
...
\caption{Promptable segmentation model.}
...
\caption{Text-prompted zero-shot segmentation.}
