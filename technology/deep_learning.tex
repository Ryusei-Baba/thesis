...
\section{深層学習}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[keepaspectratio, scale=0.30] {images/pdf/deep_neural_network}
...
\subsection{end-to-end学習}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[keepaspectratio, scale=0.70] {images/pdf/RobotGuidance_about_end-to-end}
...
\subsection{Convolutional Neural Network (CNN)}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[keepaspectratio, scale=0.50] {images/pdf/yann_CNN}
...
\newpage
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[keepaspectratio, scale=0.30] {images/pdf/deep_convolutional_neural_networks}
